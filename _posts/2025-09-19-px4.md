...
Many years ago, the hardware teams of ArduPilot and PX4 collaborated to jointly launch Pixhawk1 and Pixhawk2 as "shared" projects for both ArduPilot and PX4 platforms.


### adi sensor

为什么Pixhawk不采用ADI这种更高级的传感器来替换原有MPU系列传感器？

### What is px4_fmu-vX?

### px4_fmu-vX vs release verion

A PX4 Release (e.g., v1.13.3, v1.14.0) is a stable, versioned snapshot of the entire PX4 Autopilot project.
